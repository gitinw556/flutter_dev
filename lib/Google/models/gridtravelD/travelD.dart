...
import 'package:flutter_dev/Google/models/gridtravelD/gridfour.dart';
import 'package:material_design_icons_flutter/material_design_icons_flutter.dart';

class TheplaceTravelD extends StatefulWidget {
  final theP_T_name;
  ...
  @override
  _TheplaceTravelDState createState() => _TheplaceTravelDState();
}

class _TheplaceTravelDState extends State<TheplaceTravelD> {
  String firstHalf;
  String secondHalf;
  bool flag = true;
            ...
            child: InkWell(
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => GridFour()));
              },
              child: ClipOval(
                child: Container(
                  height: 42,
