...
import 'package:flutter_dev/Google/models/gridtravelC/gridthree.dart';
import 'package:material_design_icons_flutter/material_design_icons_flutter.dart';

class TheplaceTravelC extends StatefulWidget {
  final theP_T_name;
  ...
  @override
  _TheplaceTravelCState createState() => _TheplaceTravelCState();
}

class _TheplaceTravelCState extends State<TheplaceTravelC> {
  String firstHalf;
  String secondHalf;
  bool flag = true;
            ...
            child: InkWell(
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => GridThree()));
              },
              child: ClipOval(
                child: Container(
                  height: 42,
