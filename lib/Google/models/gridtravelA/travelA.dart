...
import 'package:flutter_dev/Google/models/gridtravelA/gridone.dart';
// import 'package:flutter_dev/Google/models/gridtravelA/weatherA.dart';
import 'package:material_design_icons_flutter/material_design_icons_flutter.dart';

class TheplaceTravelA extends StatefulWidget {
  final theP_T_name;
  ...
  @override
  _TheplaceTravelAState createState() => _TheplaceTravelAState();
}

class _TheplaceTravelAState extends State<TheplaceTravelA> {
  String firstHalf;
  String secondHalf;
  bool flag = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Stack(
        ...
        //     child: ClipRRect(
        //       child: Image(
        //         image: AssetImage(widget.theP_T_picture1),
        //         fit: BoxFit.cover,
        //       ),
        //     ),
        //  ),
            ...
            child: InkWell(
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => GridOne()));
              },
              child: ClipOval(
                child: Container(
                  height: 42,
