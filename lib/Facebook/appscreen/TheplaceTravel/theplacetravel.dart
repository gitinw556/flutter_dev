...
class TheplaceTravel extends StatefulWidget {
  final theP_T_name;
  ...
  @override
  _TheplaceTravelState createState() => _TheplaceTravelState();
}

class _TheplaceTravelState extends State<TheplaceTravel> {
  String firstHalf;
  String secondHalf;
  bool flag = true;
    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
            ...
            child: InkWell(
              ...
              child: ClipOval(
                child: Container(
                  ...
                  child: Center(
                    child: Icon(MdiIcons.arrowLeftDropCircleOutline,size: 40,color: Colors.white70),
                  ),
                ),
              ),
            ),
          ...
          //   children: <Widget>[
          //     Padding(
          //       padding: EdgeInsets.symmetric(horizontal: 73.0, vertical: 30.0),
          //       child: Text(
          //         widget.theP_T_name,
